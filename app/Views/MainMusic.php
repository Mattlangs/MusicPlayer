...
<body>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <ul>
        ...
        <div class="modal-footer">
          ...
          <a href="create_playlist"  data-bs-toggle=" modal" data-bs-target="#createPlaylist">Create New</a>
  ...
  <form action="/search_music" method="get">
...
<div>
<form method="post" action="/upload" enctype="multipart/form-data"> <!-- upload-->
    ...
    <ul id="playlist">
        <?php if (isset($music)) : ?>
            <?php foreach ($music as $song) : ?>
                <li data-src="<?= isset($song['music_src']) ? $song['music_src'] : ''; ?>">
                    <?= isset($song['music_name']) ? $song['music_name'] : ''; ?>
                </li>
            <?php endforeach; ?>
        <?php endif; ?>
    </ul>
